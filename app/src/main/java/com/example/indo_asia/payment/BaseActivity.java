...
public abstract class BaseActivity extends AppCompatActivity implements ActivityCompat.OnRequestPermissionsResultCallback,
    ...
    private static final String EXTRA_AUTHORIZATION = "https://developer.paypal.com/developer/applications/";
    private static final String EXTRA_CUSTOMER_ID = "AbC_Y2lCrio6uVhwMxvKcNMw0QATDAWg1oR1GwK0kje_YS48i-O_pPriDcZ39YKUJopQYz4TlkE8RSdt";
    ...
    protected void fetchAuthorization() {
        if (mAuthorization != null) {
            ...
            DemoApplication.getApiClient(this).getClientToken(Settings.getCustomerId(this),
                    Settings.getMerchantAccountId(this), new SortedList.Callback<ClientToken>() {
                        @Override
