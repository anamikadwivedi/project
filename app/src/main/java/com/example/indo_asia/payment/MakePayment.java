...
import com.example.indo_asia.navigate.VenmoActivity;
...
public class MakePayment extends BaseActivity {
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (resultCode == RESULT_OK) {
            ...
            showDialog(Integer.parseInt(((Exception) data.getSerializableExtra(DropInActivity.EXTRA_ERROR)).getMessage()));
        }
    }
